...
import { MessageSquare, Rocket, Database, ArrowRight, Loader2, CheckCircle2 } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-primary items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-12 text-primary-foreground max-w-xl">
          ...
          <p className="text-xl text-primary-foreground/80 mb-10 leading-relaxed">
            Join thousands of researchers and developers building the future of document intelligence.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-primary-foreground/60 text-sm">Get up and running in less than 2 minutes.</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="h-10 w-10 rounded-full bg-primary-foreground/10 flex items-center justify-center border border-primary-foreground/20">
              ...
              <div>
                ...
                <p className="text-primary-foreground/60 text-sm">Organize all your documents in one secure place.</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <div className="h-10 w-10 rounded-full bg-primary-foreground/10 flex items-center justify-center border border-primary-foreground/20">
              ...
              <div>
                ...
                <p className="text-primary-foreground/60 text-sm">Saga-based pipelines for reliable ingestion.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-muted-foreground mt-2">
              Join EcoReady AI and start managing your knowledge base today.
            </p>
          </div>
